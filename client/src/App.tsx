            ...
            theme={{
                ...
                components: {
                    ...
                    Button: {
                        ...
                        defaultActiveColor: "rgb(159,126,190)",
                        defaultHoverBorderColor: "rgb(87, 47, 124)",
                        defaultHoverBg: "rgb(87, 47, 124)",
                        defaultHoverColor: "rgb(230, 226, 233)",
                        colorPrimary: "rgb(87,47,124)",
                        colorPrimaryHover: "rgb(106,51,158)",
                        primaryShadow: "",
                        colorPrimaryActive: "rgb(117,74,156)",
                        defaultActiveBg: "rgb(68,51,83)",
